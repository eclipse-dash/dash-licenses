...
//		assertTrue(
//				contentIds.stream().allMatch(id -> id.getVersion().equals("568bc57cc5c19a2ef85e5749870b49a4cc2ab54d")));
	}
	...
	public void testShouldParseGoSumFileWithIncompatibleSuffix() throws IOException {
		...
		assertTrue(contentIds.stream().allMatch(id -> id.getNamespace().equals("gotestyourself")));
		assertTrue(
				contentIds.stream().allMatch(id -> id.getVersion().equals("7c797b5133e5460410dbb22ba779bf35e6975dea")));
	}
...
//		assertTrue(
//				contentIds.stream().allMatch(id -> id.getVersion().equals("3012a1dbe2e4bd1391d42b32f0577cb7bbc7f005")));
	}
	...
	public void shouldParseGoSumFileWithGithubHashRevision0() throws IOException {
		...
		assertTrue(contentIds.stream().allMatch(id -> id.getNamespace().equals("BurntSushi")));
//		assertTrue(
//				contentIds.stream().allMatch(id -> id.getVersion().equals("27f122750802c950b2c869a5b63dafcf590ced95")));
	}
...
//		assertTrue(
//				contentIds.stream().allMatch(id -> id.getVersion().equals("e8422f09d27ee2c8cfb2c7f8089eb9eeb0764849")));
	}

	// Advanced case: some golang dependencies has some "version suffix" to split
	// high versions. For example v2, v3, v4.
	// This suffix is applied after dependency name and can be defined with regexp
	// "/v[0-9]+".
	// Notice: "version suffix" that's not official term, we use it to simplify
	// explanation.
	@Test
...
//		assertTrue(
//				contentIds.stream().allMatch(id -> id.getVersion().equals("aa1dd9ddc28df4800d4262715c5a925fc5e0b1cf")));
	}
